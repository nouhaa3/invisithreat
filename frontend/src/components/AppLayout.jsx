    ...
    <div className="app-shell h-screen flex overflow-hidden relative">
      ...
      >
        ...
        <nav className="flex-1 px-3 py-2 flex flex-col overflow-y-auto">
          ...
          {check('use_ai_summaries') && (
            <NavItem to="/summaries" icon={
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
                <path d="M4 6h16M4 12h16M4 18h16" />
              </svg>
            } label="Summaries" collapsed={!sidebarOpen} onNavigate={() => setMobileOpen(false)}>
              Summaries
            </NavItem>
          )}
          ...
          {check('use_ai_summaries') && (
            ...
            } label="Daily Insights" collapsed={!sidebarOpen} onNavigate={() => setMobileOpen(false)}>
              Daily Insights
            </NavItem>
          )}

          {check('view_ai_analytics') && (
            <NavItem to="/ai-analytics" icon={
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
                <path d="M12 2a2 2 0 0 1 2 2c0 .74-.4 1.39-1 1.73V7h1a7 7 0 0 1 7 7h1a1 1 0 0 1 1 1v3a1 1 0 0 1-1 1h-1v1a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-1H2a1 1 0 0 1-1-1v-3a1 1 0 0 1 1-1h1a7 7 0 0 1 7-7h1V5.73c-.6-.34-1-.99-1-1.73a2 2 0 0 1 2-2z"/>
                <circle cx="7.5" cy="14.5" r="1.5"/>
                <circle cx="16.5" cy="14.5" r="1.5"/>
              </svg>
            } label="AI Analytics" collapsed={!sidebarOpen} onNavigate={() => setMobileOpen(false)}>
              AI Analytics
            </NavItem>
          )}
