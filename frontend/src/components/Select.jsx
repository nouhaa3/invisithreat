    ...
    <div ref={ref} className={`relative ${className ?? ''}`} style={style}>
      ...
      <button
        ...
        style={{
          ...
          background:   selectedTheme?.bg  ?? 'rgba(255,255,255,0.04)',
          border:       `1px solid ${selectedTheme?.border ?? (open ? 'rgba(255,107,43,0.45)' : 'rgba(255,255,255,0.12)')}`,
          color:        selectedTheme?.color ?? 'rgba(255,255,255,0.85)',
          cursor:       isDisabled ? 'not-allowed' : 'pointer',
          opacity:      isDisabled ? 0.55 : 1,
          boxShadow:    open ? '0 0 0 2px rgba(255,107,43,0.18)' : 'none',
      ...
      {open && !isDisabled && (
        <div
          ...
          style={{
            ...
            boxShadow:     '0 18px 50px rgba(0,0,0,0.6), 0 0 0 1px rgba(255,255,255,0.05)',
